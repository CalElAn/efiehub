...
import propertyMixin from "../../components/Property/property_mixin.js";
        ...
        archiveProperty() {
            ...
            .then((result) => {
                if (result.isConfirmed) {
                    this.$inertia.patch(`/properties/${this.property.slug}/archive`)
                }
            })
...
<style>
@import "../../components/Property/property_styles.css";
